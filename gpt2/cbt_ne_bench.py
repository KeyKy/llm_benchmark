...
model_path = "/mnt/chongqinggeminiceph1fs/geminicephfs/mm-base-vision/yangkang/llm/llm_codes/hf_hub/models--openai-community--gpt2"
...
base_path = "/mnt/chongqinggeminiceph1fs/geminicephfs/mm-base-vision/yangkang/llm/datasets"

train_parquet = os.path.join(base_path, "cbt/NE/train-00000-of-00001.parquet")
val_parquet = os.path.join(base_path, "cbt/NE/validation-00000-of-00001.parquet")
test_parquet = os.path.join(base_path, "cbt/NE/test-00000-of-00001.parquet")
